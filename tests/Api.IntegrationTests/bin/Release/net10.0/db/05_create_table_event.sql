...
(
    ...
    CONSTRAINT ck_event_title_length CHECK (char_length(title) BETWEEN 5 AND 100),
    CONSTRAINT ck_event_description_length CHECK (char_length(description) BETWEEN 10 AND 500),
